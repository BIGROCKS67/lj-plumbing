...
export const servicePages: Record<string, ServicePageDetail> = {
  renovations: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "The company walks the property, agrees the scope and sets a programme. Protection of the house, sequencing of trades and a single point of contact sit with L J Plumbing and Heating Services from first meeting through to handover.",
      },
      {
        title: "Trades supplied and coordinated",
        text: "L J Plumbing and Heating Services supplies and coordinates the trades a renovation needs. One company remains accountable, rather than the client managing a list of separate contractors.",
      },
      {
  ...
  bathrooms: {
    ...
    sections: [
      ...
      {
        title: "Trades supplied and coordinated",
        text: "L J Plumbing and Heating Services supplies and coordinates the finishing trades a bathroom needs, including tiling and decoration where the project requires them. One company stays responsible for the finished room.",
      },
      {
        title: "Planning and technical preparation",
  ...
  heating: {
    ...
    sections: [
      ...
      {
        title: "How the project is managed",
        text: "The system is scoped as one installation. Design, materials, first fix, second fix and commissioning stay with L J Plumbing and Heating Services, so the plant room and the finished rooms are delivered to the same standard.",
      },
      {
        title: "Trades supplied and coordinated",
        text: "Where a heating project sits inside a wider renovation, L J Plumbing and Heating Services supplies and coordinates the trades the programme needs and remains the accountable company through to handover.",
      },
      {
        title: "Planning and technical preparation",
...
export const schoolAssurance = [
  ...
  },
  {
    ...
    text: "Alongside project work, L J Plumbing and Heating Services provides planned plumbing and heating maintenance for schools and education estates.",
  },
  {
